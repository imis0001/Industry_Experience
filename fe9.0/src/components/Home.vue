...
const data = ref([
  {
    value: 0,
    title: text.value.Data_Box[0].title,
    payload: {
      content: "1,200,000",
      intro: text.value.Data_Box[0].introduction,
    },
  },
  {
    value: 1,
    title: text.value.Data_Box[1].title,
    payload: {
      content: "11,000+",
      intro: text.value.Data_Box[1].introduction,
    },
  },
  {
    value: 2,
    title: text.value.Data_Box[2].title,
    payload: {
      content: "33",
      intro:
      text.value.Data_Box[2].introduction,
    },
  },
  {
    value: 3,
    title: text.value.Data_Box[3].title,
    payload: {
      content: text.value.Data_Box[3].amount,
      intro:
      text.value.Data_Box[3].introduction,
    },
  },
]);
const value = ref(0);
...
function handleSloganClick() {
  entranceShow.value = true;
}
function handleNewsClick(i) {
  selectedNews.value = newsList.value[i];
}
function onEntranceClose() {
  entranceShow.value = false;
}
...
<template>
      ...
      <full-page :options="options" id="fullpage" ref="fullpage">
        <div class="section">
          <!-- <div class="home-intro">
            <a-typography class="home-intro-content">
              ...
              <a-typography-title :level="4" style="color: white">
                Helps you in understanding how forest fires occur and their
                causes.
              </a-typography-title>
              <a-button
                class="submit"
          ...
          <div class="image-warp">
            <div class="home-intro">
              <a-typography class="home-intro-content">
                <a-typography-title style="color: white; font-size: 55px">
                  {{text.Slogan}}
                </a-typography-title>
                <a-typography-title
                  :level="4"
              ...
              <div class="home-intro">
                <a-typography class="home-intro-content">
                  ...
                  <a-button
                    class="submit"
                    type="primary"
                    v-on:click="router.push('/information')"
                  >
            ...
            <div class="image-warp">
              <div class="home-intro">
                <a-typography class="home-intro-content">
                  ...
                  <a-typography-title :level="4" style="color: white">
                    Are you ready for a bushfire test?
                  </a-typography-title>
                  <a-button
                    class="submit"
                    type="primary"
                    v-on:click="router.push('/quiz')"
                  >
                    Bushfire Knowledge Quiz
                  </a-button>
                </a-typography>
              </div>
          ...
          <a-drawer
            ...
            placement="bottom"
            :open="entranceShow"
            @close="onEntranceClose"
          >
            <div class="entrance-drawer">
              <a-row class="row">
                      ...
                      <template #cover>
                        <div class="card-cover">
                          <img
                            ...
                            src="../assets/img/homeE1.jpeg"
                          />
                        </div>
                      </template>
                      <a-card-meta title="Dashboard">
                        <template #description>
                          Our dashboard will assist you in finding the safest
                          hiking areas, allowing you to enjoy outdoor activities
                          worry-free.
                        </template>
                      </a-card-meta>
                    </a-card>
                    ...
                    >
                      <template #cover>
                        <div class="card-cover">
                          <img
                            class="card-cover-image"
                            src="../assets/img/homeE2.jpeg"
                          />
                        </div>
                      </template>
                      <a-card-meta title="Bushfire Information">
                        <template #description>
                          Helps you in understanding how forest fires occur and
                          their causes.
                        </template>
                      </a-card-meta>
                    </a-card>
                    ...
                    >
                      <template #cover>
                        <div class="card-cover">
                          <img
                            class="card-cover-image"
                            src="../assets/img/homeE3.jpeg"
                          />
                        </div>
                      </template>
                      <a-card-meta title="Bushfire Knowledge Quiz">
                        <template #description>
                          Are you ready for a bushfire test?
                        </template>
                      </a-card-meta>
          ...
          >
            ...
            <div class="intro-bottom">
              ...
              <a-row class="row">
                ...
                <a-col class="card-warp" :span="8">
                  <div class="card-container">
                    <a-card hoverable class="card" @click="isOpen6 = true">
                      <template #cover>
                        <div class="card-cover">
                          <img
                            class="card-cover-image"
                            src="../assets/img/homeCard7.png"
                          />
                        </div>
                      </template>
        ...
        <div class="section">
          <div class="intro" style="height: 100%">
            <a-typography style="margin-top: 96px">
              <a-typography-title> {{ text.latest_news }} </a-typography-title>
            </a-typography>
            <div style="display: flex; flex: 1; flex-direction: column">
              <div style="display: flex; flex: 1; align-items: center;">
                <a-card
                @click="handleNewsClick(i)"
                hoverable
                ...
                <a-card-meta :title="news.title">
                  <template #description>{{ news.summary }}</template>
                </a-card-meta>
              </a-card>
              </div>
              <!-- <a-list
                ...
                <template #renderItem="{ item, index }">
                  ...
                  >
                    ...
                    <a-list-item-meta :description="item.author">
                      <template #title>
                        <div :href="item.href" target="_blank">
                          {{ item.title }}
                        </div>
                      </template>
                      <template #avatar
            ...
            <!-- </a-row> -->
            <!-- <div class="section-title">
              <h1 style="text-align: center; margin: 20px 0; font-size: 45px">
                What do you need to know about Australia first?
              </h1>
            </div> 
            <a-row class="row">
              <a-col class="card-warp" :span="8">
                  ...
                  <a-card hoverable class="card" @click="isOpen4 = true">
                    <template #cover>
                      <div class="card-cover">
                        <img
                          class="card-cover-image"
                          src="../assets/img/information/bushfire.jpeg"
                        />
                      </div>
                    </template>
                  ...
                  <a-card hoverable class="card" @click="isOpen5 = true">
                    <template #cover>
                      <div class="card-cover">
                        <img
                          class="card-cover-image"
                          src="../assets/img/information/flood.webp"
                        />
                      </div>
                    </template>
                    <a-card-meta :title="text.card[4].title"> </a-card-meta>
  ...
  <!-- <kit-modal :open="isOpen1" @cancel="isOpen1 = false"></kit-modal> -->
  <a-modal
    ...
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        ...
        <iframe
          width="772"
          height="434.25"
          src="https://www.youtube.com/embed/7gT7G63RGTw?si=XzUc8aNqeYMz9UnO" 
  ...
  >
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        ...
        <blockquote>
          <a-typography-paragraph
            v-for="(paragraph, index) in text.card[4].p5"
            :key="index"
          >
            {{ paragraph }}
          </a-typography-paragraph>
        ...
        <blockquote>
          <a-typography-paragraph
            v-for="(paragraph, index) in text.card[4].p7"
            :key="index"
          >
            {{ paragraph }}
          </a-typography-paragraph>
        ...
        <blockquote>
          <a-typography-paragraph
            v-for="(paragraph, index) in text.card[4].p9"
            :key="index"
          >
            {{ paragraph }}
          </a-typography-paragraph>
  ...
  <a-modal
    v-model:open="isOpen6"
    width="50%"
    :title="text.card[5].title"
    :footer="null"
    :bodyStyle="bodyStyle"
  >
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        ...
        <blockquote>
          <a-typography-paragraph
            v-for="(paragraph, index) in text.card[5].p2"
            :key="index"
          >
            {{ paragraph }}
          </a-typography-paragraph>
