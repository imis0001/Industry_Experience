    ...
    <div class="quiz-warp">
      ...
      <div v-else class="quiz-warp">
        ...
        <a-result
          ...
          :title="`${
            final.filter((f) => f).length > 0
              ? final.filter((f) => f).length > 1
                ? final.filter((f) => f).length > 4
                  ? text.congratulation4
          ...
          style="padding: 48px 256px"
          :sub-title="
            final.filter((f) => f).length > 0
              ? final.filter((f) => f).length > 1
                ? final.filter((f) => f).length > 4
                  ? text.congratulation4sub
                  : text.congratulation3sub
                : text.congratulation2sub
              : text.congratulation1sub
          "
        >
          <template #icon>
            <smile-twoTone />
