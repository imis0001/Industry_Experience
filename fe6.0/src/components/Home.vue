...
const data = ref([
  ...
  },
  {
    ...
    payload: {
      content: "11,000+",
      intro: "-	More than 11,000 Koalas were affected in the state of Victoria",
    },
  },
  {
    value: 2,
...
<template>
            ...
            <div class="home-intro">
              <a-typography class="home-intro-content">
                <a-typography-title style="color: white; font-size: 55px">
                  Explore Safely, Discover Smartly, Educate yourself
                </a-typography-title>
                <a-typography-title :level="4" style="color: white; font-size: 35px" >
                  <!-- Approximately 12 million hectares of forest are destroyed by
                    bushfire each year. -->
                    Your Guide to Australian Adventures!
                </a-typography-title>
                <!-- <a-typography-title :level="4" style="color: white">
        ...
        <div class="section">
          <div class="intro">
            ...
            <div class="section-title">
                <h1 style="text-align: center; margin: 20px 0; font-size: 45px">What do you need to know about Australia first? </h1>
            </div>
            <a-row class="row">
              <a-col class="card-warp" :span="8">
                <div class="card-container">
                  ...
                  <a-card hoverable class="card" @click="handleHelpClick">
                    <template #cover>
                      <div class="card-cover">
                        <img
                          class="card-cover-image"
                          src="../assets/img/information/heatwave.jpeg"
                        />
                      </div>
                    </template>
  ...
  >
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        <img width="100%" style="flex: 1" src="../assets/img/information/heatwave.jpeg" />
        <a-typography-paragraph>
          {{ text.card[2].p1 }}
        </a-typography-paragraph>
        <br />
  ...
  >
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        <img width="100%" style="flex: 1" src="../assets/img/information/bushfire.jpeg" />
        <a-typography-paragraph>
          {{ text.card[3].p1[0] }}
        </a-typography-paragraph>
        <br />
  ...
  >
    <a-typography class="home-modal-article">
      <div class="home-modal-content">
        <img width="100%" style="flex: 1" src="../assets/img/information/flood.webp" />
        <a-typography-paragraph>
          {{ text.card[4].p1 }}
        </a-typography-paragraph>
        <br />
